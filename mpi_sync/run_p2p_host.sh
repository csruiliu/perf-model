...
#srun -N 2 -n 2 ${OMB_PT2PT}/osu_bibw -m $MESSAGE_SIZE:$MESSAGE_SIZE -i $ITER -x $WARMUP_ITER -W $WINDOW_SIZE H H
srun -N 2 -n 2 ${OMB_PT2PT}/osu_bw -m $MESSAGE_SIZE:$MESSAGE_SIZE -i $ITER -x $WARMUP_ITER -W $WINDOW_SIZE H H
