...
RESULTS_DIR="/global/home/users/rliu5/perf-model/eval/dcgm/lammps/lrc/results/LPS_SMALL_FP32_${SLURM_JOB_ID}"

LAMMPS_DIR="/global/scratch/users/rliu5/lammps-lrc-rtx8000-fp32"
