...
#SBATCH --exclusive
#SBATCH --perf=generic
#SBATCH -o /global/homes/r/ruiliu/perf-model/eval/dcgm/milc/pm/results/MILC_TINY_FP364%j/%j.out
...
MILC_DIR="/pscratch/sd/r/ruiliu/milc-pm-a100-fp64"
...
qudatune_dir="$PWD/qudatune-generation-fp64"
