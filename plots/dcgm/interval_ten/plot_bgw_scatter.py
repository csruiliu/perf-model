...
# ---------------------------------------------------------------------------
csv_files = {
    "A100-40GB": "bgw-eps-fp64-a100-ref.csv",  # reference = A100
    "H100-SXM": "bgw-eps-fp64-h100-ref.csv",  # reference = H100
}
...
plt.tight_layout()
plt.savefig("bgw_eps_fp64_scatter.png", dpi=300, bbox_inches="tight")
