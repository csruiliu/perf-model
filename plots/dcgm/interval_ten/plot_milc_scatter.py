...
# ---------------------------------------------------------------------------
csv_files = {
    "A100-40GB": "milc-fp32-a100-ref.csv",  # reference = A100
    "H100-SXM": "milc-fp32-h100-ref.csv",  # reference = H100
}
...
plt.tight_layout()
plt.savefig("milc_fp32_scatter.png", dpi=300, bbox_inches="tight")
